...
- If the bug fix involves frontend UI changes (components, layouts, or styling), instruct the implementor to use the `/frontend-design` skill to generate the UI implementation. Add this as an explicit step in the `Step by Step Tasks` section of your plan.
